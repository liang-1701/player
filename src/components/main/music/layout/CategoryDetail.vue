    ...
    <div class="container-categoryDetail">
        <div class="category-title">
            ...
            <div class="title-content">
                ...
                <div class="control">
                    <div class="play" @click="playStore.clearAndAdd(musicStore.musicListDetail.list);playStore.play(musicStore.musicListDetail.list[0])">
        ...
        <ul class="music-list">
            <li v-for="(item, index) in musicStore.musicListDetail.list" :key="item.mid" :class="{playing:item.mid==playStore.currPlayMusic.mid}">
                ...
                <div class="name">
                    <span>{{ item.name }}</span>
                    <div class="control">
                        <svg t="1703991609601" class="icon" :class="{playHide:item.mid==playStore.currPlayMusic.mid&&playState}"  @click="playStore.play(item)" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5474" width="15" height="15"><path d="M870.2 466.333333l-618.666667-373.28a53.333333 53.333333 0 0 0-80.866666 45.666667v746.56a53.206667 53.206667 0 0 0 80.886666 45.666667l618.666667-373.28a53.333333 53.333333 0 0 0 0-91.333334z" fill="#5C5C66" p-id="5475"></path></svg>
                        <svg t="1703991646436" class="icon" :class="{playHide:!(item.mid==playStore.currPlayMusic.mid&&playState)}" @click="playStore.play(item)" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5660" width="15" height="15"><path d="M426.666667 138.666667v746.666666a53.393333 53.393333 0 0 1-53.333334 53.333334H266.666667a53.393333 53.393333 0 0 1-53.333334-53.333334V138.666667a53.393333 53.393333 0 0 1 53.333334-53.333334h106.666666a53.393333 53.393333 0 0 1 53.333334 53.333334z m330.666666-53.333334H650.666667a53.393333 53.393333 0 0 0-53.333334 53.333334v746.666666a53.393333 53.393333 0 0 0 53.333334 53.333334h106.666666a53.393333 53.393333 0 0 0 53.333334-53.333334V138.666667a53.393333 53.393333 0 0 0-53.333334-53.333334z" fill="#5C5C66" p-id="5661"></path></svg>
