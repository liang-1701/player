    ...
    <div class="container-categoryDetail">
        <div class="category-title">
            ...
            <div class="title-content">
                ...
                <div class="control">
                    <div class="play" @click="playStore.clearAndAdd(musicStore.musicListDetail.list);playCurrentSong(musicStore.musicListDetail.list[0])">
        ...
        <ul class="music-list">
            <li v-for="(item, index) in musicStore.musicListDetail.list" :key="item.mid" :class="{playing:item.mid==playStore.currPlayMusic.mid}">
                ...
                <div class="name">
                    <span>{{ item.name }}</span>
                    <div class="control">
                        <svg t="1703991609601" class="icon" :class="{playHide:item.mid==playStore.currPlayMusic.mid&&playState}"  @click="playCurrentSong(item)" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5474" width="15" height="15"><path d="M870.2 466.333333l-618.666667-373.28a53.333333 53.333333 0 0 0-80.866666 45.666667v746.56a53.206667 53.206667 0 0 0 80.886666 45.666667l618.666667-373.28a53.333333 53.333333 0 0 0 0-91.333334z" fill="#5C5C66" p-id="5475"></path></svg>
                        <svg t="1703991646436" class="icon" :class="{playHide:!(item.mid==playStore.currPlayMusic.mid&&playState)}" @click="pauseCurrentSong()" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5660" width="15" height="15"><path d="M426.666667 138.666667v746.666666a53.393333 53.393333 0 0 1-53.333334 53.333334H266.666667a53.393333 53.393333 0 0 1-53.333334-53.333334V138.666667a53.393333 53.393333 0 0 1 53.333334-53.333334h106.666666a53.393333 53.393333 0 0 1 53.333334 53.333334z m330.666666-53.333334H650.666667a53.393333 53.393333 0 0 0-53.333334 53.333334v746.666666a53.393333 53.393333 0 0 0 53.333334 53.333334h106.666666a53.393333 53.393333 0 0 0 53.333334-53.333334V138.666667a53.393333 53.393333 0 0 0-53.333334-53.333334z" fill="#5C5C66" p-id="5661"></path></svg>
                        <svg t="1703992365269" class="icon add" @click="playStore.addMusic(item)" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="11282" width="15" height="15"><path d="M925.696 384q19.456 0 37.376 7.68t30.72 20.48 20.48 30.72 7.68 37.376q0 20.48-7.68 37.888t-20.48 30.208-30.72 20.48-37.376 7.68l-287.744 0 0 287.744q0 20.48-7.68 37.888t-20.48 30.208-30.72 20.48-37.376 7.68q-20.48 0-37.888-7.68t-30.208-20.48-20.48-30.208-7.68-37.888l0-287.744-287.744 0q-20.48 0-37.888-7.68t-30.208-20.48-20.48-30.208-7.68-37.888q0-19.456 7.68-37.376t20.48-30.72 30.208-20.48 37.888-7.68l287.744 0 0-287.744q0-19.456 7.68-37.376t20.48-30.72 30.208-20.48 37.888-7.68q39.936 0 68.096 28.16t28.16 68.096l0 287.744 287.744 0z" fill="#5C5C66" p-id="11283"></path></svg>
                    </div>
                </div>
                <div class="singer">
...
const playCurrentSong = async (music: music) => {
    eventBus.emit("play-music", music);
}
...
eventBus.on("get-play-state", (data) => {
