<template>
    <div class="container-category">
        <div class="tag">
            ...
            <span class="tag-span" v-for="(item) in musicStore.categoriesDetail" :class="{tagClassActive:defaultClass==item.categoryId?true:false}" @click="getRadio(item.categoryId);setDefaultClass(item.categoryId);">
                {{item.categoryName}}
            </span>
        </div>
        <div class="category">
